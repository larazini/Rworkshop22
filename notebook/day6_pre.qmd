...
car::Anova(m6) #type 2 or 3 pero siempre es mejor especificar q tipo.
anova(m6) 
```

### Means comparisons: ej si tengo diferentes sitios con dif varianzas por ende dif means.
...
m3_cld <- cld(m3_means %>% as.data.frame(), #cld es para q calcule las letras al lado de los resultados 
              adjust = "Tukey",
              Letters = letters,
              reversed = TRUE,
              comparisons = TRUE)
